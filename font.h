...
static uint8_t font[] = {
    ...
    0x00, 0x00, 0x3C, 0x42, 0x42, 0x3C, 0x00, 0x00,  // "°" (grau)
    0x00, 0x08, 0x1C, 0x3E, 0x1C, 0x08, 0x00, 0x00,  // "▲" (seta para cima)
    0x00, 0x08, 0x14, 0x22, 0x14, 0x08, 0x00, 0x00,  // "★" (estrela)
    0x00, 0x00, 0x00, 0x1E, 0x1E, 0x00, 0x00, 0x00,  // "■" (quadrado pequeno)
    0x00, 0x00, 0x00, 0x00, 0x14, 0x08, 0x00, 0x00,  // "→" (seta para direita)
    0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x60, 0x00, // "."  (ponto final)
    0x00, 0x00, 0x00, 0x60, 0x60, 0x20, 0x40, 0x00,  // ","  (vírgula)
    0x00, 0x00, 0x38, 0x08, 0x10, 0x20, 0x20, 0x00,  // "?"  (interrogação)
    0x00, 0x00, 0x30, 0x48, 0x30, 0x00, 0x00, 0x00,  // ":"  (dois pontos)
    0x00, 0x00, 0x30, 0x48, 0x30, 0x00, 0x30, 0x00,  // ";"  (ponto e vírgula)
    0x00, 0x00, 0x08, 0x10, 0x20, 0x10, 0x08, 0x00,  // "("  (abre parêntese)
    0x00, 0x00, 0x20, 0x10, 0x08, 0x10, 0x20, 0x00,  // ")"  (fecha parêntese)
    0x00, 0x20, 0x70, 0x20, 0x20, 0x00, 0x00, 0x00,  // "!"  (exclamação)
    0x00, 0x14, 0x08, 0x3E, 0x08, 0x14, 0x00, 0x00,  // "*"  (asterisco)
